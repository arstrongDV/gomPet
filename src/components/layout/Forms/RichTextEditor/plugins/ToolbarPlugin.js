...
function BlockOptionsDropdownList({ editor, blockType, toolbarRef, setShowBlockOptionsDropDown }) {
  ...
  const dropdownOptions = [
    ...
    {
      title: blockTypeToBlockName.h1,
      icon: blockTypeToIcon.h1,
      onClick: formatLargeHeading,
      roles: []
    },
    {
      title: blockTypeToBlockName.h2,
      icon: blockTypeToIcon.h2,
      onClick: formatSmallHeading,
      roles: []
    },
    {
      title: blockTypeToBlockName.ul,
      icon: blockTypeToIcon.ul,
      onClick: formatBulletList,
      roles: []
    },
    {
      title: blockTypeToBlockName.ol,
      icon: blockTypeToIcon.ol,
      onClick: formatNumberedList,
      roles: []
    },
    {
      title: blockTypeToBlockName.quote,
      icon: blockTypeToIcon.quote,
      onClick: formatQuote,
      roles: []
    },
    {
      title: blockTypeToBlockName.code,
    ...
    <Dropdown
      ...
      label={
        <div className='dropdown__label'>
          <Icon name={blockTypeToIcon[blockType]} />
